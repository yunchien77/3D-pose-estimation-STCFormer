...
def main():
    # 設定基礎資料夾路徑
    # base_folder = r'D:/para/017'  # 請根據實際路徑調整
    model_path = 'autoencoder_model.h5'

    # 尋找所有 Angles_3D_256fps.csv 檔案
    angle_file = r'D:\para\008\008R_sa_2\008R_sa_2_3\Angles_3D_256fps.csv'
    ...
    # 逐一處理每個檔案
    try:
        process_single_file(angle_file, model, base_output_dir=None)  # 移除 base_output_dir 參數
    except Exception as e:
        print(f"處理 {angle_file} 時發生錯誤: {e}")
