...
def process_single_file(input_file_path, model, target_length=1000):
    ...
    output_file_path = os.path.join(output_dir, 'ae_fullwaves.xlsx')
    output_fig_path = os.path.join(output_dir, 'ae_fullwaves.png')
...
def main():
    ...
    base_folder = r'D:/para/021'  # Adjust path as needed
    model_path = 'autoencoder_model_full.h5'
